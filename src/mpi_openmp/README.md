...
A implementação híbrida cobre a divisão dos dados entre processos, a paralelização local com OpenMP e a sincronização global dos centroides. A melhor medição foi obtida com 1 processo MPI e 1 thread OpenMP, com `0.000055000 s`.
